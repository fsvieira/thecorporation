...
monogatari.script({"StartAskCoffe": [
	() => {
...
monogatari.script({"StartAskLunch": [
	() => {
		storage.caracters.raquel.player.love-=1;
		storage.player.raquel.love=2;
		return true;
	},
...
monogatari.script({"StartAskDate": [
	() => {
		storage.caracters.raquel.player.love-=2;
		storage.player.raquel.love+=1;
		return true;
	},
